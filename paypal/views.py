...
def setcheckout(request):
    ...
    return_url='http:/127.0.0.1:8000/payment/docheckout/' 
    ...
    if request.POST:
        ...
        try:
            ...
            if request.user.is_authenticated():
                ...
                print "No given valid amount. Please check the amount that will be charged."
        ...
        if not result:
            ...
            if request.user.is_authenticated():
                ...
                print driver.setexpresscheckouterror
            return HttpResponseRedirect(error_url)
    ...
    if request.POST:
        ...
        if not result:
            ...
            if request.user.is_authenticated():
                ...
                print "Amount %s has not been charged, server error is '%s'" % (amount, response.error)
            return HttpResponseRedirect(error_url)
        ...
        if request.user.is_authenticated():
            ...
            print "Amount %s has been successfully charged, your transaction id is '%s'" % (amount, response.trans_id)
...
def dorefund(request, error_url, success_url, template = "paypal/dorefund.html"):
    if request.POST:
        ...
        if request.user.is_authenticated():
            ...
            print "Amount %s has been successfully refunded, your transaction id is '%s'" % (amount, response.trans_id)
